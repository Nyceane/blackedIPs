...
export const PageButton = function PageButton({
  ...
  return (
    <Button size="sm" layout={isActive ? 'primary' : 'link'} onClick={onClick}>
      {page}
    </Button>
  )
}
...
const Pagination = React.forwardRef<Ref, PaginationProps>(function Pagination(props, ref) {
  ...
  const baseStyle = "py-3 px-5 flex items-center justify-between"
  ...
  return (
    <div className={baseStyle} ref={ref} {...other}>
      ...
      <span className="flex antialiased font-sans text-[13px] font-bold uppercase text-blue-gray-400">
